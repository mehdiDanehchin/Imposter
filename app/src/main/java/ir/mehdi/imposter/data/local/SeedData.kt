...
object SeedData {
    ...
    private fun normal(): List<SeedWord> = listOf(
        SeedWord("NORMAL", "اختاپوس", listOf("عمق", "فرار", "آکواریوم")),
        SeedWord("NORMAL", "سفره‌ماهی", listOf("ماسه", "پهن", "پرواز")),
        SeedWord("NORMAL", "دارکوب", listOf("جنگل", "سوراخ", "ریتم")),
        SeedWord("NORMAL", "خفاش", listOf("غار", "حشره", "وارونه")),
        SeedWord("NORMAL", "شترمرغ", listOf("کویر", "تخم", "دویدن")),
        SeedWord("NORMAL", "سنجاب", listOf("پارک", "پاییز", "ذخیره")),
        SeedWord("NORMAL", "کرم", listOf("زمین", "باران", "حفره")),
        SeedWord("NORMAL", "کرگدن", listOf("پوست", "گل", "سنگین")),
        SeedWord("NORMAL", "پنگوئن", listOf("کت", "لغزش", "رژه")),
        SeedWord("NORMAL", "لاک‌پشت", listOf("ساحل", "کند", "تخم")),
        SeedWord("NORMAL", "زالو", listOf("خون", "مرداب", "درمان")),
        SeedWord("NORMAL", "جغد", listOf("چرخش", "حکمت", "نگاه")),
        SeedWord("NORMAL", "آرمادیلو", listOf("زره", "گلوله", "حفر")),
        SeedWord("NORMAL", "آفتاب‌پرست", listOf("رنگ", "زبان", "کند")),
        SeedWord("NORMAL", "دلفین", listOf("هوش", "موج", "پرش")),
        SeedWord("NORMAL", "کوسه", listOf("ترس", "مثلث", "حمله")),
        SeedWord("NORMAL", "گرگ", listOf("زوزه", "مادر‌بزرگ", "جنگل")),
        SeedWord("NORMAL", "قورباغه", listOf("برکه", "جهش", "نیزار")),
        SeedWord("NORMAL", "طاووس", listOf("غرور", "بادبزن", "چشم")),
        SeedWord("NORMAL", "کوالا", listOf("تنبل", "استرالیا", "درخت")),
        SeedWord("NORMAL", "غواص", listOf("حباب", "عمق", "ماسک")),
        SeedWord("NORMAL", "باستان‌شناس", listOf("گنج", "موزه", "برس")),
        SeedWord("NORMAL", "دوبلور", listOf("کارتون", "میکروفون", "صدا")),
        SeedWord("NORMAL", "آتش‌نشان", listOf("نردبان", "دود", "آژیر")),
        SeedWord("NORMAL", "زرگر", listOf("عروس", "جواهر", "کوره")),
        SeedWord("NORMAL", "مجسمه‌ساز", listOf("گل", "تراش", "نمایشگاه")),
        SeedWord("NORMAL", "قالیباف", listOf("گره", "نقش", "خانه")),
        SeedWord("NORMAL", "عکاس", listOf("لحظه", "روزنامه", "فلاش")),
        SeedWord("NORMAL", "دلقک", listOf("چادر", "بینی", "خنده")),
        SeedWord("NORMAL", "مرمت‌کار", listOf("تابلو", "عتیقه", "آسیب")),
        SeedWord("NORMAL", "معدن‌چی", listOf("زغال", "تونل", "تاریکی")),
        SeedWord("NORMAL", "خلبان", listOf("کابین", "فرود", "ارتفاع")),
        SeedWord("NORMAL", "دندان‌پزشک", listOf("مسواک", "مته", "درد")),
        SeedWord("NORMAL", "کارآگاه", listOf("معما", "قاتل", "ذره‌بین")),
        SeedWord("NORMAL", "هواشناس", listOf("باران", "پیش‌بینی", "طوفان")),
        SeedWord("NORMAL", "گزارشگر", listOf("استادیوم", "فوتبال", "هیجان")),
        SeedWord("NORMAL", "داروساز", listOf("نسخه", "قفسه", "بیمار")),
        SeedWord("NORMAL", "دریانورد", listOf("کشتی", "بادبان", "بندر")),
        SeedWord("NORMAL", "نجاتگر", listOf("استخر", "سوت", "برج")),
        SeedWord("NORMAL", "ساعت‌ساز", listOf("چرخ‌دنده", "مچ", "کوک")),
        SeedWord("NORMAL", "مترونوم", listOf("تیک‌تاک", "ضرب", "تمرین")),
        SeedWord("NORMAL", "شطرنج", listOf("مهره", "فکر", "حریف")),
        SeedWord("NORMAL", "قطب‌نما", listOf("جهت", "گم", "عقربه")),
        SeedWord("NORMAL", "چراغ‌قوه", listOf("تاریکی", "باتری", "مسیر")),
        SeedWord("NORMAL", "کرونومتر", listOf("زمان", "دقیقه", "تمرین")),
        SeedWord("NORMAL", "خیاطی", listOf("سوزن", "پارچه", "پدال")),
        SeedWord("NORMAL", "گرامافون", listOf("شیپور", "صفحه", "پدر‌بزرگ")),
        SeedWord("NORMAL", "بادبادک", listOf("ریسمان", "بهار", "اوج")),
        SeedWord("NORMAL", "تلسکوپ", listOf("ستاره", "آسمان", "کهکشان")),
        SeedWord("NORMAL", "تخته‌سیاه", listOf("گچ", "کلاس", "درس")),
        SeedWord("NORMAL", "چتر", listOf("سایه", "تاشو", "دسته")),
        SeedWord("NORMAL", "ترازو", listOf("سنگینی", "تعادل", "بازار")),
        SeedWord("NORMAL", "قهوه‌ساز", listOf("عطر", "فنجان", "صبح")),
        SeedWord("NORMAL", "میکروسکوپ", listOf("باکتری", "عدسی", "آزمایشگاه")),
        SeedWord("NORMAL", "پاندول", listOf("آویزان", "نوسان", "حرکت")),
        SeedWord("NORMAL", "اکسیژن", listOf("تنفس", "بیمارستان", "قله")),
        SeedWord("NORMAL", "آینه", listOf("چهره", "آرایش", "بازتاب")),
        SeedWord("NORMAL", "فندک", listOf("جرقه", "شمع", "جیب")),
        SeedWord("NORMAL", "دفترچه", listOf("خط‌دار", "خاطره", "نوشتن")),
        SeedWord("NORMAL", "گاوصندوق", listOf("دزد", "ارز", "اسناد")),
        SeedWord("NORMAL", "قورمه‌سبزی", listOf("لیمو", "جمعه", "برنج")),
        SeedWord("NORMAL", "فسنجان", listOf("گردو", "انار", "مجلسی")),
        SeedWord("NORMAL", "ته‌دیگ", listOf("برشته", "چسبیده", "زیر")),
        SeedWord("NORMAL", "حلیم", listOf("کش‌دار", "دارچین", "گندم")),
        SeedWord("NORMAL", "فالوده", listOf("یخ", "تابستان", "خنک")),
        ...
        SeedWord("NORMAL", "اسپرسو", listOf("تلخ", "فوم", "کوچک")),
        SeedWord("NORMAL", "پاستا", listOf("خمیر", "سس", "ایتالیایی")),
        SeedWord("NORMAL", "شله‌زرد", listOf("نذر", "زعفران", "گرم")),
        SeedWord("NORMAL", "باسلوق", listOf("ژله‌ای", "نرم", "اصفهان")),
        SeedWord("NORMAL", "کباب", listOf("سیخ", "منقل", "زغال")),
        SeedWord("NORMAL", "کمپوت", listOf("قوطی", "میوه", "شهد")),
        SeedWord("NORMAL", "میرزاقاسمی", listOf("دودی", "گیلان", "گوجه")),
        SeedWord("NORMAL", "دلمه", listOf("برگ", "انگور", "پیچیدن")),
        SeedWord("NORMAL", "سوپ", listOf("بیمار", "کاسه", "پیش‌غذا")),
        SeedWord("NORMAL", "زولبیا", listOf("رمضان", "حلقه", "افطار")),
        SeedWord("NORMAL", "کله‌پاچه", listOf("سحر", "چرب", "مغز")),
        SeedWord("NORMAL", "گز", listOf("پسته", "چسب", "سوغاتی")),
    )
